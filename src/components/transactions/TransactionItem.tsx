...
import { ArrowRight, ArrowLeftRight, TrendingUp, TrendingDown, Trash2 } from 'lucide-react'
    ...
    <div className="flex items-center gap-3 py-3">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-1.5 mt-0.5">
          ...
          <span className="text-xs text-gray-400">{formatDateShort(transaction.date)}</span>
        </div>
      </div>
